...
def make_all_tables():
    ...
    # su olson
    make_tables_su_olson(Ms=[3,3,3,3,6,10,10], N_spaces = [256, 256, 256, 256, 128, 32, 32], problem_name = 'su_olson', rad_or_transport = 'rad', 
    ...
    # const cv
    make_tables_su_olson(Ms=[3,3,3,3,6,10,10], N_spaces = [256, 256, 256, 256, 128, 32, 32], problem_name = 'transfer_const_cv=0.03', rad_or_transport = 'rad', 
