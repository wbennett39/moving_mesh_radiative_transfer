...
#     # const cv
#     make_tables_su_olson(Ms=[3,4,5,6,8,10,8], N_spaces = [256, 256, 256, 256, 128, 32, 64], problem_name = 'transfer_const_cv=0.03', rad_or_transport = 'rad', 
...
#     # const cv s2
#     make_tables_su_olson(Ms=[4,4,4,4,8,10,10], N_spaces = [128, 128, 128, 128, 128, 32, 32], problem_name = 'transfer_const_cv=0.03_s2', rad_or_transport = 'rad', 
...
#     make_tables_gaussian_thin(Ms=[12,12,12,12,10,10,10], N_spaces =  [64,64,64,64,64,64,64], problem_name = 'transfer_const_cv=0.03', rad_or_transport = 'rad', 
#                                 c = 0.0, s2 = False, cv0=0.03, x0_or_sigma = 0.5, mat_or_rad ='rad', filenames = ['cv=0.03_g_phi.csv','cv=0.03_g_e.csv'], source_name_list = ['gaussian_s'], uncollided = True, moving = False)
#     # # const cv gauss s2

#     make_tables_gaussian_thin(Ms=[12,12,12,12,10,10,10], N_spaces = [64,64,64,64,128,128,128], problem_name = 'transfer_const_cv=0.03_s2', rad_or_transport = 'rad', 
#                             c = 0.0, s2 = True, cv0=0.03, x0_or_sigma = 0.5, mat_or_rad ='rad', filenames = ['cv=0.03_s2_g_phi.csv','cv=0.03_s2_g_e.csv'], source_name_list = ['gaussian_s'], uncollided = True, moving = False)
